...
import { createMint, updateMint, getOrCreateUser, createBoundingCurve, createSwap, createHash, } from "@hashfund/api";
import { HTTP_RPC_ENDPOINT, WSS_RPC_ENDPOINT } from "config";
export const onLogs = async ({ logs, signature }) => {
...
async function run() {
    ...
    connection.onLogs(HASHFUND_PROGRAM_ID, async (logs) => {
